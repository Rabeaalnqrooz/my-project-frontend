...
const resources = {
  ...
  en: {
    translation: {
      ...
      bundles_title: "Packages",
      bundles_nav_link: "Packages",
      no_bundles_found: "No packages are currently available.",
      bundle_badge: "Package",
      bundle_includes: "This Package includes:",
      is_bundle_label: 'Is this product a "Package" made of multiple products?',
      choose_product_label: "Choose Product",
      choose_product_placeholder: "Choose a product to add",
      quantity_label_short: "Quantity",
      add_to_bundle_btn: "Add",
      product_already_in_bundle: "This product is already added to the Package",
  ...
  ar: {
    translation: {
      ...
      bundles_title: "بكجات",
      bundles_nav_link: "بكجات",
      no_bundles_found: "لا توجد بكجات متاحة حالياً",
      bundle_badge: "بكج",
      bundle_includes: "هذا البكج يشمل:",
      is_bundle_label: 'هل هذا المنتج "بكج" مكزن من عدة منتجات؟',
      choose_product_label: "اختر منتج",
      choose_product_placeholder: "اختر منتج لإضافته",
      quantity_label_short: "الكمية",
      add_to_bundle_btn: "إضافة",
